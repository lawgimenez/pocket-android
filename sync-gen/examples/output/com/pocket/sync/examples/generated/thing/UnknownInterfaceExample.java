...
public final class UnknownInterfaceExample implements GraphQlSyncable, InterfaceExample, Thing {
    public static GraphQlSupport GRAPHQL = new GraphQl();

    public static final SyncableParser<UnknownInterfaceExample> JSON_CREATOR = UnknownInterfaceExample::from;

    public static final StreamingThingParser<UnknownInterfaceExample> STREAMING_JSON_CREATOR = UnknownInterfaceExample::from;

    public static final String THING_TYPE = "UnknownInterfaceExample";

    public static final Remote REMOTE = new Remote(null, Remote.Method.GET, ExamplesRemoteStyle.CLIENT_API, null);

    public static final ByteTypeParser<UnknownInterfaceExample> BYTE_CREATOR = UnknownInterfaceExample::uncompress;
    ...
    private UnknownInterfaceExample _identity;
    ...
    private UnknownInterfaceExample(Builder builder, Declared declared) {
    ...
    public static UnknownInterfaceExample from(JsonNode jsonNode, JsonConfig _config,
            Allow... allowed) {
    ...
    public static UnknownInterfaceExample from(JsonParser parser, JsonConfig _config,
    ...
    @Override
    public UnknownInterfaceExample identity() {
    ...
    public boolean equals(Thing.Equality e, Object o) {
        ...
        UnknownInterfaceExample that = (UnknownInterfaceExample) o;
    ...
    @Override
    public UnknownInterfaceExample flat() {
        return this;
    }

    @Override
    public UnknownInterfaceExample with(Changes.ThingMatch match, Thing replace) {
        return null;
    }

    @Override
    public UnknownInterfaceExample redact(StringEncrypter e) {
    ...
    @Override
    public UnknownInterfaceExample unredact(StringEncrypter e) {
        Builder _builder = builder();
    ...
    public static UnknownInterfaceExample uncompress(ByteReader _in) {
    ...
    public static class Builder implements ThingBuilder<UnknownInterfaceExample> {
        ...
        public Builder(UnknownInterfaceExample src) {
            set(src);
        }

        @Override
        public Builder set(UnknownInterfaceExample src) {
        ...
        @Override
        public UnknownInterfaceExample build() {
            return new UnknownInterfaceExample(this, new Declared(declared));
        }
    }

    public static class Mutable implements MutableThing<UnknownInterfaceExample> {
        private final Builder builder = new Builder();

        private final UnknownInterfaceExample _identity;

        private UnknownInterfaceExample _built;

        private UnknownInterfaceExample _previous;

        private MutableThing _root;

        private Mutable(UnknownInterfaceExample src, Mutables mutables, MutableThing root) {
        ...
        @Override
        public void imprint(UnknownInterfaceExample value, Mutables mutables) {
        ...
        @Override
        public UnknownInterfaceExample previous() {
            UnknownInterfaceExample v = _previous;
            _previous = null;
            return v;
        }

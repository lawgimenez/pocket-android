...
public class ExamplesConfig extends Config {
	
	public ExamplesConfig(File srcOut, File usageFile) {
		super(new Builder("Examples", srcOut, "com.pocket.sync.examples.generated")

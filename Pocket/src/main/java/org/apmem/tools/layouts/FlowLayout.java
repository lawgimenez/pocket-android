 ...
 * <p>
 * Some additional modifications were made to the class such as the ability to set {@link #maxLines}. This will truncate
...
public class FlowLayout extends ViewGroup {
    ...
    public static final int SINGLE_LINE_NO_CAP = -1;
    
    private final SparseIntArray mLineHeights = new SparseIntArray();
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            boolean newLine = maxLines != SINGLE_LINE_NO_CAP
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (lp.center || layoutCenter) {
            	int lineHeight = mLineHeights.get(lp.line);
            	if (orientation == HORIZONTAL) {
            		top = (int) ((lineHeight - child.getMeasuredHeight()) / 2f);
            		bottom = top + child.getMeasuredHeight();
            	} else {
            		left = (int) ((lineHeight - child.getMeasuredWidth()) / 2f);
    ...
    protected void applyStyle(int styleId) {
    	if (styleId == 0) {
    		return;
    	}
    	
        TypedArray a = getContext().obtainStyledAttributes(styleId, R.styleable.FlowLayout);
        try {
            applyAttributes(a);
        } finally {
            a.recycle();
    ...
    public static class LayoutParams extends ViewGroup.LayoutParams {
        ...
        /**
         * @param center true will center within a line. For example, if horizontally orientated, the view in the line will be vertically centered.
         */
